...
public class BoxWRApp extends BoxApp {
	...
	public void stopRunning() {
		...
		String sigmaStr = numberFormatTwoDigits.format((double) nleftSquaredAccumulator / zeroedTime
				- ((double) nleftAccumulator * (double) nleftAccumulator / zeroedTime / zeroedTime));
