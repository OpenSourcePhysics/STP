...
public class ThermalContactApp extends AbstractSimulation {
  ...
  ThermalContactParticleBoard board1, board2;
  ThermalContactLJSimulation sim1, sim2;
  double time;
  ...
  public void initialize() {
    ...
    time = 0;
    sim1 = new ThermalContactLJSimulation(Na, 0, Lx, Ly, dt);
    sim2 = new ThermalContactLJSimulation(0, Nb, Lx, Ly, dt);
    board1 = new ThermalContactParticleBoard(Na, 0, Lx, Ly, 0.5);
    board1.pos_x = sim1.x;
    board1.pos_y = sim1.y;
    board2 = new ThermalContactParticleBoard(0, Nb, Lx, Ly, 0.5);
    board2.pos_x = sim2.x;
    board2.pos_y = sim2.y;
    board2.Bx = Lx+0.2;
  ...
  public void reset() {
    ...
    boardFrame.removeDrawable(board1);
    boardFrame.removeDrawable(board2);
    board1 = new ThermalContactParticleBoard(0, 0, Lx, Lx*Math.sqrt(3)/2, 0.5);
    board2 = new ThermalContactParticleBoard(0, 0, Lx, Lx*Math.sqrt(3)/2, 0.5);
    board2.Bx = Lx+0.2;
    boardFrame.addDrawable(board1);
    boardFrame.addDrawable(board2);
    boardFrame.repaint();
  ...
  public void connectBoxes() {
    ...
    ThermalContactLJSimulation sim = new ThermalContactLJSimulation(Na, Nb, Lx, Ly, dt);
    ...
    ThermalContactParticleBoard board = new ThermalContactParticleBoard(Na, Nb, Lx, Ly, 0.5);
    board.pos_x = sim.x;
    board.pos_y = sim.y;
    boardFrame.removeDrawable(board1);
    boardFrame.removeDrawable(board2);
