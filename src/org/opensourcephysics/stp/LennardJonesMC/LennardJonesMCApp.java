...
package org.opensourcephysics.stp.LennardJonesMC;
 ...
 */
public class LennardJonesMCApp extends AbstractSimulation {
  LennardJonesMC mc = new LennardJonesMC();
  ...
  public static void main(String[] args) {
    SimulationControl control = SimulationControl.createApp(new LennardJonesMCApp());
