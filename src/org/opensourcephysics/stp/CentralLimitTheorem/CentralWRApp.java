...
package org.opensourcephysics.stp.CentralLimitTheorem;
 ...
 */
public class CentralWRApp extends CentralLimitTheoremApp {
  /**
  ...
  public void switchGUI() {
    ...
    Runnable runner = new Runnable() {
      public synchronized void run() {
        ...
        mainFrame.dispose();
        CentralLimitTheoremApp app = new CentralLimitTheoremApp();
...
class CentralAppControl extends EjsSimulationControl {
  CentralAppControl(CentralLimitTheoremApp model, DrawingFrame frame, String[] args) {
