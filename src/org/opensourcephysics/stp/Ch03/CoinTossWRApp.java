 ...
 */
public class CoinTossWRApp extends CoinTossApp {
  /**
  ...
  public static void main(String[] args) {
    final CoinTossWRApp app = new CoinTossWRApp();
    new CoinTossWRAppControl(app, app.histogramFrame, args);
    app.customize();
  }
 ...
 * @author Wolfgang Christian
 */
class CoinTossWRAppControl extends EjsSimulationControl {
  CoinTossWRAppControl(CoinTossWRApp model, DrawingFrame frame, String[] args) {
