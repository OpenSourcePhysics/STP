 ...
 */
public class CoinTossApp extends AbstractSimulation {
  Random random;
  int totalFlips;
  ...
  public void switchGUI() {
    ...
    Runnable runner = new Runnable() {
      public synchronized void run() {
        ...
        mainFrame.dispose();
        CoinTossWRApp app = new CoinTossWRApp();
        CoinTossWRAppControl c = new CoinTossWRAppControl(app, app.histogramFrame, null);
