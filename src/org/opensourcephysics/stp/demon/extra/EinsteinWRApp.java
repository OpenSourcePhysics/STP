...
public class EinsteinWRApp extends EinsteinApp {
  ...
  public static void main(String[] args) {
    final EinsteinWRApp app = new EinsteinWRApp();
...
class EinsteinWRAppControl extends EjsSimulationControl {
  EinsteinWRAppControl(EinsteinWRApp model, DrawingFrame frame, String[] args) {
