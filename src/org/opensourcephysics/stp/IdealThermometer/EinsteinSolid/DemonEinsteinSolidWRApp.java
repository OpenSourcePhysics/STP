...
package org.opensourcephysics.stp.IdealThermometer.EinsteinSolid;
...
public class DemonEinsteinSolidWRApp extends DemonEinsteinSolidApp {
  ...
  public void switchGUI() {
    Runnable runner = new Runnable() {
      public synchronized void run() {
        ...
        mainFrame.dispose();
        DemonEinsteinSolidApp app = new DemonEinsteinSolidApp();
  ...
  public static void main(String[] args) {
    final DemonEinsteinSolidWRApp app = new DemonEinsteinSolidWRApp();
    new EinsteinWRAppControl(app, app.histogramFrame, args);
    app.customize();
  }
...
/**
 * A custom user interface for EinsteinWRApp.
 * @author Wolfgang Christian
 */
class EinsteinWRAppControl extends EjsSimulationControl {
  EinsteinWRAppControl(DemonEinsteinSolidWRApp model, DrawingFrame frame, String[] args) {
  ...
  protected void customize() {
    ...
    add("Panel", "name=nPanel;parent=parameterPanel;position=center;layout=flow");
    ...
    add("TextField",
        "parent=outPanel;tooltip=Demon energy;size=55,23;editable=false;enabled=false;name=edNumber");
    add("Label", "parent=outPanel;text=  <E>=;tooltip=Particle energy.;horizontalAlignment=right");
    add("TextField",
        "parent=outPanel;tooltip=Particle energy.;size=55,23;editable=false;enabled=false;name=eNumber");
    add("Label", "parent=outPanel;text= r=;tooltip=Acceptance ratio.;horizontalAlignment=right");
    add("TextField",
        "parent=outPanel;tooltip=Acceptance ratio.;size=55,23;editable=false;enabled=false;name=ratio");
  }
