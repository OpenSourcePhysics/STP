...
public class HardDisksMCApp extends AbstractSimulation {
  HardDisksMC mc = new HardDisksMC();
  ...
  public static void main(String[] args) {
    SimulationControl control = SimulationControl.createApp(new HardDisksMCApp(), args);
