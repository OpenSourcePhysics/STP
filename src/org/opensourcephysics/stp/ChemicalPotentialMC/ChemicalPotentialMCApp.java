...
package org.opensourcephysics.stp.ChemicalPotentialMC;
 ...
 */
public class ChemicalPotentialMCApp extends AbstractSimulation {
  ChemicalPotentialMC mc = new ChemicalPotentialMC();
  ...
  public void reset() {
    ...
    control.setValue("maximum change \u03B4", 1.0);
  ...
  public static XML.ObjectLoader getLoader() {
    return new ChemicalPotentialMCLoader();
  }
  ...
  public static void main(String[] args) {
    SimulationControl control = SimulationControl.createApp(new ChemicalPotentialMCApp());
