...
package org.opensourcephysics.stp.randomwalk.RandomWalk1d;
 ...
 */
public class RandomWalk1dWRApp extends RandomWalk1dApp {
  /**
  ...
  public void switchGUI() {
    ...
    Runnable runner = new Runnable() {
      public synchronized void run() {
        ...
        mainFrame.dispose();
        RandomWalk1dApp app = new RandomWalk1dApp();
  ...
  public static void main(String[] args) {
    final RandomWalk1dWRApp app = new RandomWalk1dWRApp();
    new OneDimensionalWalkWRAppControl(app, app.histogramFrame, args);
    app.customize();
  }
 ...
 * @author Wolfgang Christian
 */
class OneDimensionalWalkWRAppControl extends EjsSimulationControl {
  OneDimensionalWalkWRAppControl(RandomWalk1dApp model, DrawingFrame frame, String[] args) {
