...
package org.opensourcephysics.stp.randomwalk.RandomWalk2d;
 ...
 */
public class RandomWalk2dWRApp extends RandomWalk2dApp {
  /**
  ...
  public void switchGUI() {
    ...
    Runnable runner = new Runnable() {
      public synchronized void run() {
        ...
        mainFrame.dispose();
        RandomWalk2dApp app = new RandomWalk2dApp();
  ...
  public static void main(String[] args) {
    final RandomWalk2dWRApp app = new RandomWalk2dWRApp();
...
class TwoDimensionalWalkWRAppControl extends EjsSimulationControl {
  TwoDimensionalWalkWRAppControl(RandomWalk2dApp model, DrawingFrame frame, String[] args) {
