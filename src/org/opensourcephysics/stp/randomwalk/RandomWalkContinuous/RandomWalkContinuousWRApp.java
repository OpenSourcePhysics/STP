 ...
 */
public class RandomWalkContinuousWRApp extends RandomWalkContinuousApp {
  /**
  ...
  public void switchGUI() {
    ...
    Runnable runner = new Runnable() {
      public synchronized void run() {
        ...
        mainFrame.dispose();
        RandomWalkContinuousApp app = new RandomWalkContinuousApp();
  ...
  public static void main(String[] args) {
    final RandomWalkContinuousWRApp app = new RandomWalkContinuousWRApp();
...
class VariableStepLengthWalkAppControl extends EjsSimulationControl {
	VariableStepLengthWalkAppControl(RandomWalkContinuousApp model, DrawingFrame frame, String[] args) {
