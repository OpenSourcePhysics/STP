...
public class Ising1DWRApp extends Ising1DApp {
  /**
  ...
  public static void main(String[] args) {
    final Ising1DWRApp app = new Ising1DWRApp();
    new Ising1DControl(app, app.eFrame, args);
    app.customize();
  }
...
/**
 * A custom user interface for Ising1DApp.
 * @author Wolfgang Christian
 */
class Ising1DControl extends EjsSimulationControl {
  Ising1DControl(Simulation model, DrawingFrame frame, String[] args) {
  ...
  protected void customize() {
    ...
    add("Panel", "name=temperaturePanel;parent=paramPanel;position=center;layout=flow,0,0,0");
    add("Label", "position=west; parent=temperaturePanel;text=  T = ;tooltip=Temperature;horizontalAlignment=right");
    add("NumberField", "parent=temperaturePanel;tooltip=Temperature;variable=Temperature;format=0.000;size=45,23");
    ...
    add("NumberField", "parent=fieldPanel;tooltip=External field.;variable=External field;format=0.000;size=45,23");
