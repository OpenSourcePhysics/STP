...
package org.opensourcephysics.stp.einsteinsolid.Microstates;
 ...
 */
public class EinsteinSolidMicrostatesApp extends AbstractCalculation {
  int Ea, Eb, Na, Nb;
...
*/
  public static void main(String[] args) {
    EinsteinSolidMicrostatesApp app = new EinsteinSolidMicrostatesApp();
