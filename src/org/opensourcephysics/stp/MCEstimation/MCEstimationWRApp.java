...
package org.opensourcephysics.stp.MCEstimation;
 ...
 */
public class MCEstimationWRApp extends MCEstimationApp {
  ...
  public void switchGUI() {
    Runnable runner = new Runnable() {
      public synchronized void run() {
        ...
        mainFrame.dispose();
        MCEstimationApp app = new MCEstimationApp();
  ...
  public static void main(String[] args) {
    final MCEstimationWRApp app = new MCEstimationWRApp();
...
class MonteCarloEstimationControl extends EjsCalculationControl {
  MonteCarloEstimationControl(MCEstimationApp model, DrawingFrame frame, String[] args) {
