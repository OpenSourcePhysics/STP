...
public class Potts2DApp extends AbstractSimulation {
  Potts2D ising;
  ...
  public void doStep() {
    ...
    plotFrame.append(0, ising.mcs, ising.order);
  ...
  public void stopRunning() {
    ...
    control.println("<M> = "+nf.format(ising.M_acc*norm*ising.N));
  ...
  public void reset() {
    ...
    control.setAdjustableValue("Temperature", nf.format(ising.criticalTemperature));
