 ...
 */
public class PercolationApp extends AbstractSimulation {
  ...
  public void initialize() {
    ...
    grid.resizeGrid(L, L);
    lattice = new PercolationClusters(L);
  ...
  public static void main(String args[]) {
    SimulationControl.createApp(new PercolationApp());
  }
