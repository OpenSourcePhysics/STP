 ...
 */
public class OneDimensionalWalkWRApp extends OneDimensionalWalkApp {
  /**
  ...
  public static void main(String[] args) {
    final OneDimensionalWalkWRApp app = new OneDimensionalWalkWRApp();
...
class OneDimensionalWalkWRAppControl extends EjsSimulationControl {
  OneDimensionalWalkWRAppControl(OneDimensionalWalkApp model, DrawingFrame frame, String[] args) {
